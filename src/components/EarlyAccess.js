...
const EarlyAccess = () => {
  ...
  return (
    <div className="bg-dark-blue-main">
      <div className="bg-dark-blue-intro text-center z-20 py-12 w-[85%]  px-10 xl:w-1/2 mx-auto transform translate-y-24 rounded-md">
